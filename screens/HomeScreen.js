...
export default function HomeScreen({ route, navigation }) {
    ...
    const [messages, setMessages] = useState([
        // ['6436c56ff34d03b63232d3d9', 22, 76],
        // ['6436c56ff34d03b63232d3d8', 20, 75],
        // ['643687f157efe0737b659ca5', 19.1684091, 72.8414437],
    ]);
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            // setLongitude(event_data.data.event.location.coordinates[1]);
            // setLatitude(event_data.data.event.location.coordinates);
            setmapRegion({
            ...
            setMessages((messages) => {
                ...
                for (
                    let i = 0;
                    i < event_data.data.event.personnels.length;
                    i++
                ) {
                    newMessages[event_data.data.event.personnels[i]._id] = null;
                }
                return newMessages;
            });
        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.topContainer}>
                <View style={styles.searchContainer}>
                    ...
                    />
                    <Text style={styles.searchInput}>{eventName}🚩️🚩️</Text>
